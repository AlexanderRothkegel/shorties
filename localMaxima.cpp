 ...
 try
  {
        ...
        desc.add_options()
            ...
            ("smooth,s", po::value<int>()->default_value(15), "n.punkt-Glättung vorm maxima berechnen")
				("minimum-relative,m", po::value<double>()->default_value(0.0)," minimum fraction of range")
				("minimum-absolut,M", po::value<double>()->default_value(0.0)," minimum value for maximum")
